...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 py-16">
        ...
        <div class="text-center px-4">
            ...
            <p class="text-gray-600 text-sm sm:text-base">Download code files and resources to practice along with the lessons.</p>
        </div>
        ...
        <div class="text-center px-4">
            ...
            <p class="text-gray-600 text-sm sm:text-base">Learn from industry professionals with real-world experience.</p>
        </div>
    </div>
